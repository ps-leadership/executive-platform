...
export const articles: Article[] = [
  {
    slug: "from-invisible-effort-to-intentional-investment",
    title: "From Invisible Effort to Intentional Investment",
    excerpt:
      "A reflection on the hidden effort behind collaboration and why organizations need to recognize it as intentional investment.",
  ...
  {
    slug: "free-work-is-not-free",
    title: "Free Work Is Not Free: The Hidden Currency of Collaboration",
    excerpt:
      "Why the invisible effort that sustains collaboration can become a structural cost—and why leaders need to make it visible.",
    date: "January 2026",
    category: "Leadership & Organizations",
    readingTime: "4 min read",
    sourceUrl:
      "https://medium.com/@pri.bit/free-work-is-not-free-the-hidden-currency-of-collaboration-dd67029e1dfc",
    contentFile: "free-work-is-not-free.md",
  },

  {
    slug: "why-readiness-beats-technology-in-digital-success",
    title: "Why Readiness Beats Technology in Digital Success",
    excerpt:
      "Technology alone does not transform organizations. Readiness, strategic alignment, leadership, culture, and learning capacity determine whether digital transformation creates real strategic advantage.",
